...
def bag_of_words_encoder(smiles: List[str]) -> OneHotEncoder:
    """
...
def smiles_to_one_hot_array_features(smiles: List[str], encoder: OneHotEncoder, max_length=None) -> np.array:
    """
